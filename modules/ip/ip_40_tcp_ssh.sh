...
OPTIONAL_VARS=TCP_PROTECTION TCP_DOCKER SSH_DOCKER SSH_REQUIRE_WHITELIST WHITELISTED_IPS WHITELISTED_DOMAINS
DEFAULTS=TYPECHAIN=0 ENABLE_TCP_PROTECT=true GAMESERVERPORTS=27015 SSH_PORT=22 LOG_PREFIX_TCP_RCON_BLOCK=TCP_RCON_BLOCK: TCP_PROTECTION= TCP_DOCKER= SSH_DOCKER= SSH_REQUIRE_WHITELIST=false WHITELISTED_IPS= WHITELISTED_DOMAINS=
EOF
}
