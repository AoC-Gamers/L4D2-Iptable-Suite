...
OPTIONAL_VARS=FIREWALL_LOG_HOST_ALIAS ENABLE_PACKET_NORMALIZATION_LOGS ENABLE_MALFORMED_FILTER
DEFAULTS=TYPECHAIN=0 L4D2_GAMESERVER_UDP_PORTS=27015 L4D2_SOURCETV_UDP_PORTS=27020 LOG_PREFIX_INVALID_SIZE=INVALID_SIZE: LOG_PREFIX_MALFORMED=MALFORMED: FIREWALL_LOG_HOST_ALIAS= ENABLE_PACKET_NORMALIZATION_LOGS=false ENABLE_MALFORMED_FILTER=false
EOF
}
