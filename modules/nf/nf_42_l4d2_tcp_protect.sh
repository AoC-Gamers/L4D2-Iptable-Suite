...
OPTIONAL_VARS=L4D2_GAMESERVER_TCP_PORTS LOG_PREFIX_TCP_RCON_BLOCK FIREWALL_LOG_HOST_ALIAS
DEFAULTS=TYPECHAIN=0 L4D2_GAMESERVER_TCP_PORTS= LOG_PREFIX_TCP_RCON_BLOCK=TCP_RCON_BLOCK: FIREWALL_LOG_HOST_ALIAS=
EOF
}
